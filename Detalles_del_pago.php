                                                ...
                                                <form class="checkout-new-shipping-address-form" method="post" action="./Deliver/tarjeta.php">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-8">
                                                            ...
                                                            <input type="text" name="cnamec" id="ccname" minlength="7" maxlength="45" style="width:20rem;height:40px;border-top-left-radius:10px;border-top-right-radius:10px;" class="form-control" required="true" oninput="allow_alphabets(this)" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-8">
                                                            <label for="shipping.email">Número de tarjeta <text style="color: red;">*</text></label>
                                                            <input type="tel" placeholder="xxxx xxxx xxxx xxxx" name="card" id="shippingemail" style="height:40px;border-top-left-radius:10px;border-top-right-radius:10px;" minlength="16" maxlength="19" class="form-control" title="Introduzca un número de crédito de tarjeta válido." autocomplete="off" required="true" value="<?php echo get_value('card'); ?>">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <div style="display:flex;max-width:80%">
                                                                <select style="margin: 0 3px;height:40px;border-top-left-radius:10px;border-top-right-radius:10px;width:40%;border:1px solid #ced4da ;background-color:#f8f8f8;color:#495057;" name="expm" title="month">
                                                                ...
                                                                <select style="margin: 0 3px;height:40px;border-top-left-radius:10px;border-top-right-radius:10px;width:40%;border:1px solid #ced4da;background-color:#f8f8f8;color:#495057;" name="expy" title="year">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="tel" placeholder="XXX" name="cvv" id="shippingpostalcode" style="height:40px;border-top-left-radius:10px;border-top-right-radius:10px;" maxlength="3" minlength="3" title="3 dígitos mostrados en el reverso de su Tarjeta" class="form-control null" autocomplete="off" required="true" value="<?php echo get_value('cvv'); ?>">
                                                    ...
                                                    <section class="continue-button py-2 mb-4" id="continueButtonParent">
                                                        <div class="d-flex justify-content-end">
                                                            ...
                                                            <button type="submit" id="btn-continue" class="btn btn-primary" style="border-radius:  8px;">Pagar y continuar &gt;</button>
                                                        </div>
                                                    </section>
                                                </form>
                                            </div>
